...
class _GardenerProfileScreenState extends State<GardenerProfileScreen>
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) => CreateAppointmentScreen(
                                          gardenerData: widget.gardenerData,
                                        ),
                                      ),
                                    );
                                  },
  ...
  Widget _buildCertificateItem(String name, String authority, String certDate, String expiryDate, IconData icon, Color color) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
