...
class _MessagesScreenState extends State<MessagesScreen> {
  ...
  final List<ChatMessage> messages = [
    ChatMessage(text: "Xin chào! Tôi muốn hỏi về sản phẩm xà lách của vườn.", isMe: true, time: "10:30"),
    ChatMessage(
      text: "Chào bạn! Cảm ơn bạn đã quan tâm đến sản phẩm của chúng tôi. Xà lách hiện tại rất tươi và chất lượng tốt.",
      isMe: false,
      time: "10:32",
    ),
    ChatMessage(text: "Giá cả như thế nào ạ? Và có thể giao hàng không?", isMe: true, time: "10:35"),
    ChatMessage(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("0901 234 567", style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                        ],
                      ),
                    ),
        ...
        children: [
          if (!message.isMe) ...[
            Container(
              ...
              height: 32,
              decoration: BoxDecoration(color: Color(0xFFB8E6B8), shape: BoxShape.circle),
              child: Icon(Icons.person, color: Color(0xFF4CAF50), size: 16),
            ),
            SizedBox(width: 8),
          ],
          Flexible(
