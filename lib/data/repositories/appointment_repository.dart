...
class AppointmentRepository extends GetxController {
  ...
  Future<bool> createAppointment(CreateAppointmentRequest request) async {
    try {
      ...
      final response = await _apiService.post('/appointments', data: request.toJson());
  ...
  Future<AppointmentsResponse> getAppointments(String accountId) async {
    try {
      final response = await _apiService.get('/accounts/$accountId/appointments');
  ...
  Future<bool> cancelAppointment(
    ...
    try {
      ...
      final response = await _apiService.patch(
        ...
        data: {'cancellationReason': cancellationReason, 'cancelledBy': cancelledBy},
      );
